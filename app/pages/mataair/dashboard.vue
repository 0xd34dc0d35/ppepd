...
<template>
  <div class="w-full h-full flex flex-col bg-brand-cream overflow-hidden">
    ...
    <!-- NAVBAR -->
    <nav class="relative shrink-0 flex items-center justify-between px-4 sm:px-6 backdrop-blur-xl bg-teal-500/10 border-b border-teal-400/20 shadow-sm" style="z-index:10; height:50px">
