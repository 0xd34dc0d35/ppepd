  ...
  <div class="min-h-screen bg-brand-cream/30">
    ...
    <div v-if="isLoading" class="flex items-center justify-center min-h-screen">
      <div class="flex flex-col items-center gap-4">
        ...
        <p class="text-sm font-bold text-brand-charcoal/40">Memuat artikel...</p>
      </div>
    </div>
    ...
    <div v-else-if="notFound" class="flex flex-col items-center justify-center min-h-screen text-center px-6">
      ...
      <h2 class="text-2xl font-black text-brand-green-dark mb-2">Artikel Tidak Ditemukan</h2>
      <p class="text-sm text-brand-charcoal/50 mb-8">Konten yang Anda cari tidak tersedia atau telah dipindahkan.</p>
      <NuxtLink to="/berita-events" class="px-6 py-2.5 rounded-full bg-brand-green text-white text-xs font-black uppercase tracking-widest hover:bg-brand-green-dark transition-all">
        Kembali ke Katalog
      </NuxtLink>
    </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 px-8 pb-10 max-w-4xl mx-auto">
          <div class="flex items-center gap-2 mb-4">
            <span :class="[
              ...
              item.type === 'berita' ? 'bg-brand-blue text-white' : 'bg-brand-orange text-white'
            ]">
